...
void main() {
  group('defaults', () {
    setUpUI((tester) async {
      await tester.pumpWidget(CupertinoTestApp(widget: CupertinoSpinBox()));
    });
  ...
  group('tap', () {
    setUpUI((tester) async {
      await tester
          .pumpWidget(CupertinoTestApp(widget: CupertinoSpinBox(value: 1)));
    });
  ...
  group('input', () {
    setUpUI((tester) async {
      final spinBox = CupertinoSpinBox(value: 1, autofocus: true);
  ...
  testUI('decimals', (tester) async {
    final spinBox = CupertinoSpinBox(min: -1, max: 1, value: 0.5, decimals: 2);
    await tester.pumpWidget(CupertinoTestApp(widget: spinBox));
  ...
  group('callbacks', () {
    ...
    setUpUI((tester) async {
      ...
      final spinBox =
          CupertinoSpinBox(value: 1, onChanged: (v) => values.add(v));
      await tester.pumpWidget(CupertinoTestApp(widget: spinBox));
    });
  ...
  group('long press', () {
    ...
    setUpUI((tester) async {
      values = StreamController<double>();
      final spinBox =
          CupertinoSpinBox(min: -5, max: 5, onChanged: (v) => values.add(v));
      await tester.pumpWidget(CupertinoTestApp(widget: spinBox));
    });
